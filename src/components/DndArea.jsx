...
function PlayerButton({ player, onClick, isSelected }) {
  return (
    <button
      ...
      className={`px-4 py-3 font-bold rounded-lg transition-all duration-200 shadow-lg ${
        isSelected
...
function PlayerSlot({ slot, player, onRemove }) {
  return (
    <div
      className={`relative flex-1 min-h-[80px] flex items-center justify-center rounded-xl border-3 border-dashed transition-all ${
        player 
